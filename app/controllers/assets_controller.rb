...
class AssetsController < ApplicationController
  ...
  def update
    ...
    if @asset.update_attributes(params[:asset])
      ...
      redirect_to @asset, :notice  => t(:asset_update)
  ...
  def get
    ...
    if asset
      ...
      #use x_sendfile to tell the webserver what file to send, and let the web server bother with the details of streaming the file out to the client.
      #send_file asset.uploaded_file.path, :type => asset.uploaded_file_content_type, :x_sendfile=>true
      ...
      flash[:error] = "You do not have access to this file!" + ":Rails_ROOT/config/amazon_s3.yml"
